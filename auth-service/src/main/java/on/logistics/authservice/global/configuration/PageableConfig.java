package on.logistics.authservice.global.configuration;

import java.util.List;
import lombok.RequiredArgsConstructor;
import on.logistics.authservice.global.enums.PageSize;
import on.logistics.authservice.global.enums.PageSortBy;
