...
import on.logistics.authservice.infrastructure.feign.exception.ExternalApiException.ExternalApiBadRequestException;
import on.logistics.authservice.infrastructure.feign.exception.ExternalApiException.ExternalApiClientException;
import on.logistics.authservice.infrastructure.feign.exception.ExternalApiException.ExternalApiNotFoundException;
import on.logistics.authservice.infrastructure.feign.exception.ExternalApiException.ExternalApiServerException;
import on.logistics.authservice.infrastructure.feign.exception.ExternalApiException.WrongResponseTypeApiException;
