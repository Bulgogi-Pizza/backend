...
public class DirectionsController {
    ...
    public ResponseEntity<CommonResponse<?>> getRoute(
        ...
        DirectionsResponseDto resDTO = directionsService.getRoute(start, end, option, cartype);
        return ResponseEntity.ok().body(CommonResponse.success(resDTO));
    }
