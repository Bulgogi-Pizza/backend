...
public class FeignClientResponseUtils {
  ...
  private static <T> T parseCommonResponseToT(Class<T> responseType, CommonResponse commonResponse)
  ...
  private static List parseCommonResponseToList(CommonResponse commonResponse) throws JsonProcessingException {
    return objectMapper.readValue(
        objectMapper.writeValueAsString(commonResponse.data()),
        List.class
    );
  ...
  private static <T> T parseObjectToT(Class<T> responseType, Object o) throws JsonProcessingException {
    return objectMapper.readValue(
