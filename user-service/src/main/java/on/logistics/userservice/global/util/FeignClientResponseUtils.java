...
import on.logistics.userservice.infrastructure.feign.exception.ExternalApiException.ExternalApiBadRequestException;
import on.logistics.userservice.infrastructure.feign.exception.ExternalApiException.ExternalApiClientException;
import on.logistics.userservice.infrastructure.feign.exception.ExternalApiException.ExternalApiNotFoundException;
import on.logistics.userservice.infrastructure.feign.exception.ExternalApiException.ExternalApiServerException;
import on.logistics.userservice.infrastructure.feign.exception.ExternalApiException.WrongResponseTypeApiException;
